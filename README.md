...
`/opt/gopath/src/github.com/Hanzheng2021/orthrus`

It checks out the `research` branch and, finally, builds the `client` and `server` executables under
`/opt/gopath/src/github.com/Hanzheng2021/orthrussever` and `/opt/gopath/src/github.com/Hanzheng2021/orthrus/client`
respectively.
...
Change working directory to `/opt/gopath/src/github.com/Hanzheng2021/orthrus/deployment`
 ...
 * 2 listening ports: `server-to-server-port`, `server-to-client-port` such that `server-to-client-port`=`server-to-server-port+2`
 ...
 Comments in `/opt/gopath/src/github.com/Hanzheng2021/orthrus/sampleconfig/serverconfig/config*.yml` files describe how to configure a server.
...
### Client configuration
 Comments in `/opt/gopath/src/github.com/Hanzheng2021/orthrus/sampleconfig/clientconfig/*peer-config.yml` files describe how to configure a client.
...
1. Add the servers and clients of the experiment  in `/opt/gopath/src/github.com/Hanzheng2021/orthrus/deployment/cloud-instance.info`.
...
Performance evaluation metrics *throughput* and *latency* can be calculated with the `/opt/gopath/src/github.com/Hanzheng2021/orthrus/tools/perf-eval.py` with the logs generated by the `/opt/gopath/src/github.com/Hanzheng2021/orthrus/server/server` and traces generated by the `/opt/gopath/src/github.com/Hanzheng2021/orthrus/client/client` binaries.

With /opt/gopath/src/github.com/Hanzheng2021/orthrus as working directory, the script should be called as follows:
