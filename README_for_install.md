...
`mkdir -p /opt/gopath/src/github.com/anonymous/`

Clone this repository unter the directory you created:

`cd /opt/gopath/src/github.com/anonymous/`
...
The default path to the repository is set to: `/opt/gopath/src/github.com/anonymous/orthrus/`.
...
Detailed instructions can be found  [here](https://github.com/anonymous/orthrus/tree/research-iss/deployment).
